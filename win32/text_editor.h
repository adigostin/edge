...
namespace edge
{
	struct __declspec(novtable) text_editor_i
	{
		...
		virtual handled process_mouse_button_down (mouse_button button, modifier_key mks, D2D1_POINT_2F pd) = 0;
		virtual handled process_mouse_button_up   (mouse_button button, modifier_key mks, D2D1_POINT_2F pd) = 0;
		virtual void process_mouse_move (modifier_key mks, D2D1_POINT_2F pd) = 0;
