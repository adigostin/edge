...
{ 
	struct __declspec(novtable) text_editor_i
	{
		...
		virtual void process_mouse_button_down (mouse_button button, modifier_key modifier_keys, POINT pixel, D2D1_POINT_2F dip) = 0;
		virtual void process_mouse_button_up   (mouse_button button, modifier_key modifier_keys, POINT pixel, D2D1_POINT_2F dip) = 0;
		virtual void process_mouse_move (modifier_key modifier_keys, POINT pixel, D2D1_POINT_2F dip) = 0;
		virtual handled process_virtual_key_down (uint32_t virtualKey, modifier_key modifier_keys) = 0;
		virtual handled process_virtual_key_up (uint32_t key, modifier_key modifier_keys) = 0;
